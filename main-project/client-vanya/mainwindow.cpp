    ...
    , ui(new Ui::MainWindow)
{
    ...
    this->setPalette(Pal);
    this->setStyleSheet("background-color: rgb(25, 28, 31);");
    createActions();
    createMenus();
    ...
    connect(this, &MainWindow::signalTemp, ui->widget_6, &WidgetTemp1::slotTemp);
...
void MainWindow::baseValueInit(){
    emit signalSpeed("1");
    emit signalCharge("1");
    emit signalTop("1");
    emit signalTemp("1");
    Variant_1->setChecked(true);
}
