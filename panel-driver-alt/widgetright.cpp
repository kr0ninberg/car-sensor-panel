...
//    checkedVariant2 = true;
    checkedVariant1 = true;
    checkedVariant2 = false;
}
...
////////////////////////////
    ...
    if(checkedVariant1)
    {
        ...
        painter.drawText(QRect(74, 50, 200, 26), Qt::AlignVCenter | Qt::AlignLeft,  "172 км");
...
//        painter.drawText(QRect(74, 86*2+8+4, 200, 46), Qt::AlignVCenter | Qt::AlignLeft,  "84 км");
        ...
        painter.drawText(QRect(74, 50+20, 200, 26), Qt::AlignVCenter | Qt::AlignLeft,  "Пробег за день");
        painter.drawText(QRect(74, 46+86+3-4, 200, 40), Qt::AlignVCenter | Qt::AlignLeft,  "Электрорежим");
        painter.drawText(QRect(74, 46+86+50, 200, 40), Qt::AlignVCenter | Qt::AlignLeft,  "Гибридный режим");

        painter.drawPixmap(QPoint(painter.viewport().x() - 5, center.y() - 75), Distance);
        painter.drawPixmap(QPoint(painter.viewport().x() + 10, center.y()), AVG);
        painter.drawPixmap(QPoint(painter.viewport().x() + 10, center.ry() + 60), Power);
    }
    if (checkedVariant2)
    {
